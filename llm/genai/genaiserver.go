...
func NewGenaiServer(gpus discover.GpuInfoList, model string, modelname string, modeltype string, inferdevice string, f *ggml.GGML, adapters, projectors []string, opts api.Options, numParallel int) (GenaiServer, error) {
